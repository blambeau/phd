...
The label $\tau$ is used to denote the so-called \emph{non-observable} transitions, which allow modeling an agent changing state without such change being monitored by its environment. 
