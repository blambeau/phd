...
A \emph{trace} is a finite sequence of event labels \artifact{$t= \textless l_0,\ldots,l_{n} \textgreater$} with $l_i \in \Sigma$. Unlike executions, a trace never contains $\tau$ labels. 
