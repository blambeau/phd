...
\noindent where $Machine$ is the composition between the controller, actuators and sensor given previously and $Internals$ is the set of labels of internal machine events $\{\artifact{start-signal}, \artifact{stop-signal}, \artifact{non-zero-speed}, \artifact{zero-speed}, \ldots\}$. 
