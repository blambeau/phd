...
The sets of traces $\mathcal{L}_{strong}(H)$ and $\mathcal{L}_{weak}(H)$ result from the scenarios that can be ``produced'' by the hMSC under strong and weak sequential composition, respectively. Such ``production'' simply results from the concatenation of bMSCs alongs paths admissible by the hMSC.
