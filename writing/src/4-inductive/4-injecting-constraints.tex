...
\begin{figure}[H]
\centering
\scalebox{.30}{\includegraphics*{src/4-inductive/images/dc-augmented-pta}}
...
\begin{figure}
\centering
\scalebox{.5}{\includegraphics*{src/4-inductive/images/alarm-sensor}}
...
\begin{figure}
\centering
\scalebox{.3}{\includegraphics*{src/4-inductive/images/alarm-unfolded-pta}}
...
\begin{figure}
\centering
\scalebox{.3}{\includegraphics*{src/4-inductive/images/goal-unfolded-pta}}
