...
\caption{Propagating fluents along the PTA to prune inductive search space\label{dc-augmented-pta}; DC stands for \emph{DoorsClosed}.}
\end{figure}
...
\caption{Unfolding the alarm sensor LTS on the PTA\label{Fig.:alarm-unfolded-pta}.}
\end{figure}
