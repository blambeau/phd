...
\KwIn{Information about mandatory merge constraints}
\KwOut{A System LTS, consistent with the initial collection}
\vspace{0.15cm}
$//$ build an initial PTA \\
$A \leftarrow $ {\tt Initialize($Sc$)}\\
\vspace{0.15cm}
$//$ perform mandatory merging first\\
\While{$(q,q') \leftarrow $ {\tt MandatoryMergePair($A$)}}{
  $A \leftarrow $ {\tt Merge$(A,q,q')$}\\
}
\vspace{0.15cm}
