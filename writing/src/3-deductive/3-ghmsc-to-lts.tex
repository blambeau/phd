...
In this definition, $q_u$, $q_t$ and $q_f$ denote g-LTS states where the fluent is \emph{unassigned}, \emph{true} and \emph{false}, respectively (see Fig.~\ref{image:fluent-glts}). Moreover,
